...
// 1. Import your toggle component!
...
export default function HomeSection() {
  ...
  return (
    /* 2. Wrap everything in a div that fills the screen and changes color */
    <div className="min-h-screen bg-[#fffafa] text-black transition-colors duration-500 dark:bg-[#120a15] dark:text-white">
      <section className="mx-auto max-w-5xl space-y-8 px-4 py-8">
        
        {/* 3. Add the toggle button at the top right */}
        ...
        {/* --- Your existing Footer/Contact section --- */}
